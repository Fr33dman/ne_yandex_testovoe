...
## Задание 2 - exercise_2

Все комментарии оставил в коде, проблема коллизий вызвана транзакциями - добавил доп проверку на существование сущности с state="inprogress",
если таковой имеется то ищем новое обращение (можно было добавить еще timesleep перед новым обращением в бд, но возможно это лишнее)
